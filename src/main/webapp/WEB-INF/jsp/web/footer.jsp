        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 text-center text-sm-left">
                    <div class="mb-4 mb-sm-0"><a class="d-inline-block" href="index.html"><img width="100" src="${pageContext.servletContext.contextPath}/img/logo-light.png" alt="MStore"/></a>
                        <div class="navbar-lang-switcher dropdown border-light mt-3 mb-0 mt-sm-0">
                            <div class="dropdown-toggle text-white" data-toggle="dropdown"><img width="20" src="${pageContext.servletContext.contextPath}/img/flags/en.png" alt="English"/><span>USD</span>
                            </div>
                            <ul class="dropdown-menu" style="width: 150px;">
                                ...
                                <li><a class="dropdown-item" href="index.html"><img class="mr-2" width="20" src="${pageContext.servletContext.contextPath}/img/flags/fr.png" alt="Français"/>Français</a></li>
            ...
            <div class="row pt-4">
                ...
                <div class="col-sm-6 text-center text-sm-right">
                    <div class="d-inline-block"><img width="187" src="${pageContext.servletContext.contextPath}/img/cards.png" alt="Payment methods"/>
                    </div>
                </div>
            </div>
        </div>
